...
@pytest.mark.parametrize("deposit, withdraw, expected", [(200,100,100),(50,10,40),(1200,200,1000)])
def test_bank_transanction(zero_bank_account, deposit, withdraw, expected):
